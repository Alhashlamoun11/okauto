                        ...
                        <form method="POST" action="{{ route('user.data.submit') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="number" class="form-control form--control" name="zip" value="{{ old('zip') }}">
                                </div>
                                <div class="form-group col-sm-6">
                                    <label class="form-label">@lang('City')</label>
<input type="text" class="form-control form--control" name="city" value="{{ old('city') }}" pattern="[A-Za-z\s]+" maxlength="100" required>
                                </div>
                            </div>
                            <div class="form-group">
