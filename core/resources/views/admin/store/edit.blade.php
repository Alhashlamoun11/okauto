                        ...
                        <div class="row">
                            <div class="col-xxl-4 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <x-image-uploader image="{{ $user->store_data->store_image }}" class="w-100"
                                        type="vehicleStore" :required=false name="store_image" />
                                </div>
                            </div>
                            <div class="col-xxl-8 col-lg-6">
                                <div class="form-group select2--parent position-relative">
                                    ...
                                    <select name="zone_id" class="form-control select2-basic" required>
                                        ...
                                        @foreach ($zones as $zone)
                                            <option value="{{ $zone->id }}" @selected($zone->id == @$user->zone_id)>
                                                {{ __($zone->name) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="name"
                                        value="{{ old('name', @$user->store_data->name) }}" required>
                                </div>
                                <div class="form-group">
                                    <label>@lang('Location')</label>
                                    <input class="form-control" type="text" name="location"
                                        value="{{ old('location', @$user->location->name) }}" required>
                                </div>
                            </div>
                        </div>
