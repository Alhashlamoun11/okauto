                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <label class="required">@lang('Maximum Image Upload')</label>
                                    <div class="input-group">
                                        <input class="form-control" name="max_image_upload" type="number" value="{{ getAmount(gs('max_image_upload')) }}" required>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="rental_charge" type="number" value="{{ getAmount(gs('rental_charge')) }}" step="any" required>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Rental Tax')</label>
                                    <div class="input-group">
                                        <input class="form-control" name="rental_tax" type="number" value="{{ getAmount(gs('rental_tax')) }}" step="any" required>
                                        <span class="input-group-text">@lang('%')</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Initial Map Latitude')</label>
                                    <input class="form-control" name="init_lat" type="text" value="{{ gs('init_lat') }}" required>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Initial Map Longitude')</label>
                                    <input class="form-control" name="init_long" type="text" value="{{ gs('init_long') }}" required>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <div class="form-group">
