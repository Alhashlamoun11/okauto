...
<div class="row">
    ...
    <div class="col-lg-12">
    <button type="button" onclick="printTransactions()" class="btn btn-outline--dark btn-sm">
...
function printTransactions() {
    const section = document.getElementById("printable-transactions");
    const printWindow = window.open('', '', `width=${screen.availWidth},height=${screen.availHeight}`);

    // Copy styles from current page
    const styles = [...document.querySelectorAll('link[rel="stylesheet"], style')];
    const headContent = styles.map(style => style.outerHTML).join('');

    // Build the new print document
