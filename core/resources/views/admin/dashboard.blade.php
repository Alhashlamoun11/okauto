...
@section('panel')
                        ...
                        <div class="widget-card bg--success">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">@lang('Total Paid')</p>
                                </div>
                            </div>
    ...
    <div class="card box-shadow3 h-100">
        <div class="card-body">
            <h5 class="card-title">@lang('Coupon Discount')</h5>
            <div class="widget-card-wrapper">
                ...
                <div class="widget-card bg--success">
                    <div class="widget-card-left">
                        ...
                        <div class="widget-card-content">
                            <h6 class="widget-card-amount">{{ showAmount($coupon['net_profit']) }}</h6>
                            <p class="widget-card-title">@lang('Net Coupon Profit')</p>
                        </div>
                    </div>
                ...
                <div class="widget-card bg--primary">
                    <div class="widget-card-left">
                        ...
                        <div class="widget-card-content">
                            <h6 class="widget-card-amount">{{ showAmount($coupon['total_charge']) }}</h6>
                            <p class="widget-card-title">@lang('Total Charges')</p>
                        </div>
                    </div>
                ...
                <div class="widget-card bg--danger">
                    <div class="widget-card-left">
                        ...
                        <div class="widget-card-content">
                            <h6 class="widget-card-amount">{{ showAmount($coupon['total_discount']) }}</h6>
                            <p class="widget-card-title">@lang('Total Discounts')</p>
                        </div>
                    </div>
