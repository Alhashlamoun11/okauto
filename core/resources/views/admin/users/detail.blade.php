...
<button class="btn btn-sm btn-outline--dark" onclick="printSection()">Print</button>
    ...
    <div id="user_detail_section" class="row gy-3">
        ...
        <div class="col-xxl-8 col-xl-7 col-lg-12">
            <div class="row gy-3">
                <div class="col-xl-6 col-sm-6">
                    <x-widget value="{{ showAmount($user->balance) }}" title="Balance" style="2" link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" icon="las la-wallet" color="primary" />
                </div>
                <div class="col-xl-6 col-sm-6">
                    <x-widget value="{{ showAmount($totalDeposit) }}" title="Total Payments" style="2" link="{{ route('admin.deposit.list') }}?search={{ $user->username }}" icon="las la-money-bill" color="success" />
                </div>

                <div class="col-xl-6 col-sm-6">
                    <x-widget value="{{ showAmount($totalWithdrawals) }}" title="Total Withdrawan" style="2" link="{{ route('admin.withdraw.data.all') }}?search={{ $user->username }}" icon="las la-hand-holding-usd" color="danger" />
                </div>
                <div class="col-xl-6 col-sm-6">
                ...
                <div class="col-xl-6 col-sm-6">
                    <x-widget value="{{ showAmount($totalRented) }}" title="Total Rented" style="2" link="{{ route('admin.vehicle.index') }}?search={{ $user->username }}" icon="las la-file-invoice" color="green" />
                </div>
            </div>
        </div>
    </div>
...
function printSection() {
    const section = document.getElementById("user_detail_section");
