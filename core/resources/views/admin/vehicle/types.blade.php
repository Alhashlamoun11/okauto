                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button class="btn btn-sm btn-outline--primary editButton" data-vehicle_type="{{ $vehicleType }}" data-image="{{ getImage(getFilepath('vehicleType') . '/' . $vehicleType->image, getFileSize('vehicleType')) }}">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <x-image-uploader name="image" class="w-100" type="vehicleType" :required="true"/>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="keywords" type="text" value="{{ old('keywords') }}" required>
                                </div>
                                <div class="form-group">
                                    <label>@lang('Head')</label>
                                    <input class="form-control" name="head" type="text" value="{{ old('head') }}" required>
                                </div>
                                <div class="form-group">
    ...
    <script>
        (function($) {
            ...
            $('.editButton').on('click', function() {
                ...
                modal.find('[name=keywords]').val(vehicleType.name_keywords);
                modal.find('[name=title]').val(vehicleType.title);
                modal.find('[name=head]').val(vehicleType.head);
                modal.find('[name=image]').removeAttr('required');
                modal.find('[name=description]').val(vehicleType.description);
                modal.find('[name=meta_description]').val(vehicleType.meta_description);
            ...
            var defaultImage = `{{ getImage(getFilePath('vehicleType'), getFileSize('vehicleType')) }}`;
            modal.on('hidden.bs.modal', function() {
                modal.find('.image-upload-preview').attr('style', `background-image: url(${defaultImage})`);
