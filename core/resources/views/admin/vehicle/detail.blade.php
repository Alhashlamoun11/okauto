...
<button class="btn btn-sm btn-outline--dark" onclick="printSection()">Print</button>
    ...
    <div id="vehicle_detail_section" class="row gy-4 mb-none-30 justify-content-center flex-lg-row-reverse">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="product-info-thumb">
                                    <div class="product-slider">
                                        <div class="slick-item">
                                            <img class="fit-image" src="{{ getImage(getFilePath('vehicle') . '/' . @$vehicle->image, getFileSize('vehicle')) }}" alt="@lang('image')"">
                                        </div>
                                ...
                                <div class="product-info-bottom">
                                    ...
                                    <h6 class="product-info-bottom-price">
                                        {{ showAmount($vehicle->price) }}  / {{$vehicle->day_hours}} @lang('H')
                                    </h6>
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="fw-bold">{{ getAmount($vehicle->security_deposit) }} {{ __(gs('cur_text')) }}</span>
                        </li>                                        
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Seat')
...
function printSection() {
    const section = document.getElementById("vehicle_detail_section");
