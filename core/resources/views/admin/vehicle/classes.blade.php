                ...
                <form method="post" action="">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select name="vehicle_type_id" class="form-control select2"  data-minimum-results-for-search="-1" required>
    ...
    <script>
        (function($) {
            ...
            $('.editButton').on('click', function() {
                ...
                modal.find('select[name=vehicle_type_id]').val(vehicleClass.vehicle_type_id).trigger('change');
