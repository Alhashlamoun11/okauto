    ...
    Route::middleware(['check.status','registration.complete'])->group(function () {
        ...
        Route::namespace('User')->group(function () {
            ...
            Route::controller('UserController')->group(function(){
                ...
                // Route::post('rented/{id}/cancel', 'CancelRented')->name('rented.cancel');
            ...
            Route::controller('VehicleController')->name('vehicle.')->prefix('vehicle')->group(function () {
                ...
                Route::post('store/settings/update', 'storeUpdateSettings')->name('store.update_settings');
            ...
            //Notifications
                Route::controller('UserController')->name('notifications.')->prefix('notifications')->group(function () {
                    Route::post('mark-all-read', 'markAllNotificationsRead')->name('markAllRead');
            ...
            Route::controller('RentalController')->name('rental.')->prefix('rental')->group(function () {
                ...
                Route::get('TestNotification/{message}', 'TestNotification')->name('TestNotification');
                ...
                Route::post('ongoing/{id}/sendVerify', 'sendOnGoingVerifyCode')->name('ongoing.sendVerify');

                Route::post('change_end_date/', 'ChangeRentEndDate')->name('vendor.change_end_date');
                Route::post('change_end_date_status/', 'ChangeRentEndDateStatus')->name('vendor.change_end_date_status');
                
                Route::post('{rental}/approve-date-change', "approveDateChange")->name('approve-date-change');

                Route::post('{rental}/reject-date-change', 'rejectDateChange')->name('reject-date-change');
        ...
        Route::prefix('deposit')->name('deposit.')->controller('Gateway\PaymentController')->group(function(){
            ...
            Route::get('updateRent/{rentId}', 'depositUpdateRent')->name('Rent');
            Route::post('updateRent', 'depositUpdateRent')->name('updateRent');
        ...
        // Coupons
        Route::prefix('coupon')->name('coupon.')->controller('Admin\CouponsController')->group(function(){
                Route::post('verify','verifyCoupon')->name('verifyCoupon');
            });
    });
});
