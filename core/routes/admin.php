...
Route::namespace('Auth')->group(function () {
    ...
    Route::get('extra-services', 'ExtraServiceController@index')->name('extra-services.index');
    Route::post('extra-services/store', 'ExtraServiceController@store')->name('extra-services.store');
    Route::post('extra-services/update/{id}', 'ExtraServiceController@update')->name('extra-services.update');
    
    Route::middleware('admin')->middleware('log_requests')->group(function () {
    Route::controller('AdminController')->group(function(){
        ...
        //Notification
        Route::middleware('access:15')->group(function () {
        ...
        //Report Bugs
        Route::middleware('access:14')->group(function () {
    ...
    // Users Manager
    Route::middleware('access:7')->group(function () {
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function(){
        ...
        Route::match(['get', 'post'], 'send-notification/{id}', function ($id) {
            if (request()->isMethod('get')) {
                return app()->call('App\Http\Controllers\ManageUsersController@showNotificationSingleForm', ['id' => $id]);
            } elseif (request()->isMethod('post')) {
                return app()->call('App\Http\Controllers\ManageUsersController@sendNotificationSingle', ['id' => $id]);
            }
    ...
    Route::controller('ManageVehicleTypeController')->prefix('vehicle')->group(function () {
        // type
    ...
    // Brand
    Route::middleware('access:16')->group(function () {
    ...
    // Employee
    Route::middleware('access:3')->group(function () {
    Route::controller('EmployeeController')->prefix('employee')->name('employee.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
        Route::get('logs', 'employee_logs')->name('logs');
    });
    });
    // Coupons
    Route::middleware('access:17')->group(function () {
    Route::controller('CouponsController')->prefix('coupons')->name('coupons.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    // Zone
    Route::middleware('access:2')->group(function () {
    ...
    // Store
    Route::middleware('access:4')->group(function () {
    ...
    // manage Vehicle
    Route::middleware('access:5')->group(function () {
    ...
    // manage Rental
    Route::middleware('access:6')->group(function () {
    ...
    // Subscriber
    Route::middleware('access:12')->group(function () {
    Route::controller('SubscriberController')->prefix('subscriber')->name('subscriber.')->group(function(){
        Route::get('/', 'index')->name('index');
        Route::match(['get', 'post'], 'send-email', function () {
            if (request()->isMethod('get')) {
                return app()->call('App\Http\Controllers\SubscriberController@sendEmailForm');
            } else {
                return app()->call('App\Http\Controllers\SubscriberController@sendEmail');
            }
        })->name('send.email');
    ...
    // Report
    Route::middleware('access:11')->group(function () {
    ...
    // Admin Support
    Route::middleware('access:10')->group(function () {
    ...
    // Language Manager
    Route::middleware('access:13')->group(function () {
    ...
    Route::controller('GeneralSettingController')->group(function(){
        ...
        // Logo-Icon
        Route::match(['get', 'post'], 'setting/logo-icon', function () {
            if (request()->isMethod('get')) {
                return app()->call('App\Http\Controllers\GeneralSettingController@logoIcon');
            } else {
                return app()->call('App\Http\Controllers\GeneralSettingController@logoIconUpdate');
            }
