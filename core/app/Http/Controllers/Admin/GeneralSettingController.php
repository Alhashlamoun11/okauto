...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        $request->validate([
            ...
            'rental_tax'    => 'required|integer|gte:0',
            'api_key'          => 'required|string',
            'init_lat'        => 'required|numeric',
            'init_long'        => 'required|numeric',
        ]);
        ...
        $general->rental_tax       = $request->rental_tax;
        $general->api_key          = $request->api_key;
        $general->init_lat         = $request->init_lat;
        $general->init_long        = $request->init_long;
