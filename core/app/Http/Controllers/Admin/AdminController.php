...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        $coupon['total_charge']   = Deposit::successful()->sum('charge');
        $coupon['total_discount'] = Deposit::successful()->sum('coupon_discount');
        $coupon['net_profit']     = $coupon['total_charge'] - $coupon['total_discount'];


        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'withdrawals', 'coupon'));
    }
