...
ALTER TABLE `general_settings` ADD `available_version` VARCHAR(40) NULL DEFAULT "2" AFTER `last_cron`;
...
ALTER TABLE `general_settings` ADD `init_lat` DECIMAL(28,8) NOT NULL DEFAULT '0' AFTER `socialite_credentials`, ADD `init_long` DECIMAL(28,8) NOT NULL DEFAULT '0' AFTER `init_lat`;
...
ALTER TABLE `general_settings` DROP `last_cron`;


UPDATE gateways 
SET image = CASE `code`
   WHEN 101 THEN '663a38d7b455d1715091671.png'
    WHEN 102 THEN '663a3920e30a31715091744.png'
    WHEN 103 THEN '663a39861cb9d1715091846.png'
    WHEN 104 THEN '663a39494c4a91715091785.png'
    WHEN 105 THEN '663a390f601191715091727.png'
    WHEN 106 THEN '663a38c9e2e931715091657.png'
    WHEN 107 THEN '663a38fc814e91715091708.png'
    WHEN 109 THEN '663a36c2c34d61715091138.png'
    WHEN 110 THEN '663a393a527831715091770.png'
    WHEN 111 THEN '663a3995417171715091861.png'
    WHEN 112 THEN '663a384d54a111715091533.png'
    WHEN 501 THEN '663a35efd0c311715090927.png'
    WHEN 503 THEN '663a36a8d8e1d1715091112.png'
    WHEN 504 THEN '663a36b7b841a1715091127.png'
    WHEN 505 THEN '663a368e753381715091086.png'
    WHEN 506 THEN '663a367e46ae51715091070.png'
    WHEN 113 THEN '663a38ed101a61715091693.png'
    WHEN 114 THEN '663a39afb519f1715091887.png'
    WHEN 115 THEN '663a387ec69371715091582.png'
    WHEN 116 THEN '663a361b16bd11715090971.png'
    WHEN 119 THEN '663a386c714a91715091564.png'
    WHEN 120 THEN '663a35b9ca5991715090873.png'
    WHEN 121 THEN '663a3897754cf1715091607.png'
    WHEN 507 THEN '663a35cd25a8d1715090893.png'
    WHEN 508 THEN '663a38b8d57a81715091640.png'
    WHEN 509 THEN '663a38a59d2541715091621.png'
    WHEN 122 THEN '663a39b8e64b91715091896.png'
    WHEN 123 THEN '663a3628733351715090984.png'
    WHEN 1000 THEN '663b50fc3b21c1715163388.png'
    WHEN 510 THEN '663a35db4fd621715090907.png'
    WHEN 124 THEN '663a397a70c571715091834.png'
    WHEN 125 THEN '663a34d5d1dfc1715090645.png'
END 
WHERE code IN (101, 102, 103, 104, 105, 106, 107, 109, 110, 111, 112, 501, 503, 504, 505, 506, 113, 114, 115, 116, 119, 120, 121, 507, 508, 509, 122, 123, 1000, 510, 124, 125);
